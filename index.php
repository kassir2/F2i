...
<html lang="en">
  ...
  <body class="p-3 m-0 border-0 bd-example">
    ...
    <div class ="container bg-warning mt-5">
        ...
        <form action="result.php" method='get' class='row'>
            <?php
            ...
            echo input("4", "telephone", "votre numero", "tel", "entrer un numero");
            echo input("4", "password", "votre password", "password", "entrer un password");
            echo input("4", "password2", "confirmer", "password", "confirmer");
            echo input("4", "Envoyer", "envoyer", "submit", "Envoyer");
            ?>
        </form>
